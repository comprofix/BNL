...
[Run]
Filename: "{app}\usb\Ingenico\Ingenico Telium\Ingenico_Telium_USBCOM_v1.35.0_2019-11-18_setup.exe"; Parameters: "/S"; WorkingDir: "{app}"; StatusMsg: "Installing Ingenico USB driver"; Tasks: INGENICO_USB_DRIVERS; AfterInstall: "IngenicoDriverAfterInstall"; MinVersion: 0.0,6.0; 
...
Filename: "{app}\usb\VeriFone (VX6xx, VX7xx, VX8xx)\5.0.4.0-B2\64\silent_install.bat"; WorkingDir: "{app}"; StatusMsg: "Installing Verifone USB driver"; Tasks: VERIFONE_USB_DRIVERS; Check: "IsWin64"; MinVersion: 0.0,6.0; Flags: 64bit 
Filename: "{app}\usb\VeriFone (VX6xx, VX7xx, VX8xx)\5.0.4.0-B2\32\silent_install.bat"; WorkingDir: "{app}"; StatusMsg: "Installing Verifone USB driver"; Tasks: VERIFONE_USB_DRIVERS; Check: "not IsWin64"; MinVersion: 0.0,6.0; Flags: 32bit 
Filename: "{app}\vc_redist.x86.exe"; Parameters: "/install /passive /quiet /norestart"; WorkingDir: "{app}"; StatusMsg: "Installing VC Redist..."; MinVersion: 0.0,6.0; 
Filename: "{app}\BridgeClient.exe"; Parameters: "remove noecho"; WorkingDir: "{app}"; MinVersion: 0.0,6.0; Flags: skipifdoesntexist 
Filename: "netsh"; Parameters: "firewall delete allowedprogram ""{app}\Eftsrv.exe"""; StatusMsg: "Removing EFT-Server from Windows Firewall..."; MinVersion: 0.0,5.01.2600 Service Pack 2; OnlyBelowVersion: 0.0,6.0; 
Filename: "netsh"; Parameters: "firewall delete allowedprogram ""{app}\Eftclnt.exe"""; StatusMsg: "Removing EFT-Client from Windows Firewall..."; MinVersion: 0.0,5.01.2600 Service Pack 2; OnlyBelowVersion: 0.0,6.0; 
Filename: "netsh"; Parameters: "firewall delete allowedprogram ""{app}\EmsClt.exe"""; StatusMsg: "Removing EMS-Client from Windows Firewall..."; MinVersion: 0.0,5.01.2600 Service Pack 2; OnlyBelowVersion: 0.0,6.0; 
Filename: "netsh"; Parameters: "firewall delete allowedprogram ""{app}\EmsCltUI.exe"""; StatusMsg: "Removing EMS-ClientUI from Windows Firewall..."; MinVersion: 0.0,5.01.2600 Service Pack 2; OnlyBelowVersion: 0.0,6.0; 
Filename: "netsh"; Parameters: "firewall delete allowedprogram ""{app}\EmsClt_APP.exe"""; StatusMsg: "Removing EMS-ClientApp from Windows Firewall..."; MinVersion: 0.0,5.01.2600 Service Pack 2; OnlyBelowVersion: 0.0,6.0; 
Filename: "netsh"; Parameters: "advfirewall firewall delete rule name=EFT-Server"; StatusMsg: "Removing EFT-Server from Windows Firewall..."; MinVersion: 0.0,6.0; 
Filename: "netsh"; Parameters: "advfirewall firewall delete rule name=EFT-Client"; StatusMsg: "Removing EFT-Client from Windows Firewall..."; MinVersion: 0.0,6.0; 
Filename: "netsh"; Parameters: "advfirewall firewall delete rule name=EMS-Controller"; StatusMsg: "Removing EMS-Controller from Windows Firewall..."; MinVersion: 0.0,6.0; 
Filename: "netsh"; Parameters: "advfirewall firewall delete rule name=EMS-Client"; StatusMsg: "Removing EMS-Client from Windows Firewall..."; MinVersion: 0.0,6.0; 
Filename: "netsh"; Parameters: "advfirewall firewall delete rule name=EMS-ClientUI"; StatusMsg: "Removing EMS-ClientUI from Windows Firewall..."; MinVersion: 0.0,6.0; 
Filename: "netsh"; Parameters: "firewall set allowedprogram name=EFT-Server program=""{app}\Eftsrv.exe"" mode=ENABLE profile=ALL"; StatusMsg: "Adding EFT-Server to Windows Firewall..."; Components: EFT_Server PCEFTPOS_Client Development; MinVersion: 0.0,5.01.2600 Service Pack 2; OnlyBelowVersion: 0.0,6.0; 
Filename: "netsh"; Parameters: "advfirewall firewall add rule name=EFT-Server action=allow dir=in enable=yes profile=private,domain interfacetype=any protocol=any program=""{app}\Eftsrv.exe"""; StatusMsg: "Adding EFT-Server to Windows Firewall..."; Components: EFT_Server PCEFTPOS_Client Development; MinVersion: 0.0,6.0; 
Filename: "netsh"; Parameters: "firewall set allowedprogram name=EMS-Client program=""{app}\EmsClt.exe"" mode=ENABLE profile=ALL"; StatusMsg: "Adding EMS-Client to Windows Firewall..."; Components: PCEFTPOS_Client; MinVersion: 0.0,5.01.2600 Service Pack 2; OnlyBelowVersion: 0.0,6.0; 
Filename: "netsh"; Parameters: "advfirewall firewall add rule name=EMS-Client action=allow dir=in enable=yes profile=private,domain interfacetype=any protocol=any program=""{app}\EmsClt.exe"""; StatusMsg: "Adding EMS-Client to Windows Firewall..."; Components: PCEFTPOS_Client; MinVersion: 0.0,6.0; 
Filename: "netsh"; Parameters: "firewall set allowedprogram name=EMS-ClientUI program=""{app}\EmsCltUI.exe"" mode=ENABLE profile=ALL"; StatusMsg: "Adding EMS-ClientUI to Windows Firewall..."; Components: PCEFTPOS_Client; MinVersion: 0.0,5.01.2600 Service Pack 2; OnlyBelowVersion: 0.0,6.0; 
Filename: "netsh"; Parameters: "advfirewall firewall add rule name=EMS-ClientUI action=allow dir=in enable=yes profile=private,domain interfacetype=any protocol=any program=""{app}\EmsCltUI.exe"""; StatusMsg: "Adding EMS-ClientUI to Windows Firewall..."; Components: PCEFTPOS_Client; MinVersion: 0.0,6.0; 
Filename: "netsh"; Parameters: "firewall set allowedprogram name=EFT-Client program=""{app}\Eftclnt.exe"" mode=ENABLE profile=ALL"; StatusMsg: "Adding EFT-Client to Windows Firewall..."; Components: EFT_Server PCEFTPOS_Client Development; MinVersion: 0.0,5.01.2600 Service Pack 2; OnlyBelowVersion: 0.0,6.0; 
Filename: "netsh"; Parameters: "advfirewall firewall add rule name=EFT-Client action=allow dir=in enable=yes profile=private,domain interfacetype=any protocol=any program=""{app}\Eftclnt.exe"""; StatusMsg: "Adding EFT-Client to Windows Firewall..."; Components: EFT_Server PCEFTPOS_Client Development; MinVersion: 0.0,6.0; 
Filename: "{app}\Eftsrv.exe"; Parameters: "remove noecho"; WorkingDir: "{app}"; Components: EFT_Server PCEFTPOS_Client Development; MinVersion: 0.0,6.0; 
Filename: "{app}\EftClnt.exe"; Parameters: "remove noecho"; WorkingDir: "{app}"; Components: PCEFTPOS_Client Development Development; MinVersion: 0.0,6.0; 
...
Filename: "{app}\ConfigWiz.exe"; Parameters: "/SilentInstall /UninstallService /ServiceName EMSClientService /ServiceDisplayName EMS-Client /ServicePath ""{app}\EmsClt.exe"""; WorkingDir: "{app}"; MinVersion: 0.0,6.0; 
Filename: "{app}\Eftsrv.exe"; Parameters: "install noecho"; WorkingDir: "{app}"; StatusMsg: "Installing EFT-Server service..."; Components: EFT_Server PCEFTPOS_Client Development; MinVersion: 0.0,6.0; 
Filename: "{app}\EftSrvUI.exe"; Parameters: "/install"; WorkingDir: "{app}"; StatusMsg: "Installing EFT-Server UI..."; MinVersion: 0.0,6.0; 
Filename: "sc.exe"; Parameters: "config RemedyEFTPOSServer start= delayed-auto"; WorkingDir: "{app}"; StatusMsg: "Setting EFT-Server service startup type to Automatic (Delayed Start)..."; MinVersion: 0.0,6.0; 
Filename: "{app}\EftClnt.exe"; Parameters: "install noecho"; WorkingDir: "{app}"; StatusMsg: "Installing EFT-Client service..."; Components: PCEFTPOS_Client Development; MinVersion: 0.0,6.0; 
Filename: "{app}\ConfigWiz.exe"; Parameters: "/SilentInstall /InstallService /ServiceName EMSClientService /ServiceDisplayName EMS-Client /ServicePath ""{app}\EmsClt.exe"""; WorkingDir: "{app}"; StatusMsg: "Installing EMS-Client service..."; Tasks: EMS_CLIENT_SERVICE; MinVersion: 0.0,6.0; 
Filename: "{app}\EmsCltUI.exe"; Parameters: "/Reinstall"; WorkingDir: "{app}"; StatusMsg: "Installing EMS-Client UI service..."; Tasks: EMS_CLIENT_SERVICE; MinVersion: 0.0,6.0; 
Filename: "{app}\ConfigWiz.exe"; Parameters: "/NoServiceRestart"; WorkingDir: "{app}"; StatusMsg: "Launching Linkly Configuration Wizard..."; Components: PCEFTPOS_Client; MinVersion: 0.0,6.0; 
Filename: "{app}\ConfigWiz.exe"; Parameters: "/NoServiceRestart /EFTSRV"; WorkingDir: "{app}"; StatusMsg: "Launching Linkly Configuration Wizard..."; Components: EFT_Server; MinVersion: 0.0,6.0; 
Filename: "{app}\ConfigWiz.exe"; Parameters: "/NoServiceRestart /LoadFile development.xml"; WorkingDir: "{app}"; StatusMsg: "Launching Linkly Configuration Wizard..."; Components: Development; MinVersion: 0.0,6.0; 
Filename: "{app}\ConfigWiz.exe"; Parameters: "/SilentInstall /StopAllServices"; WorkingDir: "{app}"; StatusMsg: "Closing Linkly applications..."; MinVersion: 0.0,6.0; 
Filename: "{app}\ConfigWiz.exe"; Parameters: "/SilentInstall /SetEftSrvRestartOnFailure TRUE /SetEftCltRestartOnFailure TRUE /SetEmsCtrlRestartOnFailure TRUE /SetEmsCtlRestartOnFailure TRUE /SetEftSrvInteractWithDesktop FALSE /SetEftCltInteractWithDesktop FALSE /SetEmsCtrlInteractWithDesktop FALSE /SetEmsCltInteractWithDesktop FALSE"; WorkingDir: "{app}"; StatusMsg: "Config services..."; MinVersion: 0.0,6.0; 
Filename: "{app}\ConfigWiz.exe"; Parameters: "/SilentInstall /StartEFTSRV"; WorkingDir: "{app}"; StatusMsg: "Starting EFT-Server..."; Components: EFT_Server PCEFTPOS_Client Development; MinVersion: 0.0,6.0; 
Filename: "{app}\ConfigWiz.exe"; Parameters: "/SilentInstall /StartEFTCLT"; WorkingDir: "{app}"; StatusMsg: "Starting EFT-Client..."; Components: PCEFTPOS_Client Development; MinVersion: 0.0,6.0; 
Filename: "{app}\ConfigWiz.exe"; Parameters: "/SilentInstall /StartEMSCLT"; WorkingDir: "{app}"; StatusMsg: "Starting EMS-Client..."; Tasks: EMS_CLIENT_SERVICE; MinVersion: 0.0,6.0; 
Filename: "{app}\EftSrvUI.exe"; WorkingDir: "{app}"; StatusMsg: "Starting EFT-Server UI..."; Components: EFT_Server PCEFTPOS_Client Development; MinVersion: 0.0,6.0; Flags: nowait
Filename: "{app}\EmsCltUI.exe"; WorkingDir: "{app}"; StatusMsg: "Starting EMS-Client UI..."; Tasks: EMS_CLIENT_SERVICE; MinVersion: 0.0,6.0; Flags: nowait
Filename: "{app}\BCX_Migrator.exe"; Parameters: "/VERYSILENT /SUPPRESSMSGBOXES"; WorkingDir: "{app}"; StatusMsg: "Moving old files."; MinVersion: 0.0,6.0; 
Filename: "sc"; Parameters: "delete PceCntrl"; StatusMsg: "Removing controller"; Components: EFT_Server PCEFTPOS_Client Development; MinVersion: 0.0,6.0; 
Filename: "{app}\EftClntUI.exe"; WorkingDir: "{app}"; StatusMsg: "Starting EFT-Client UI..."; Components: PCEFTPOS_Client Development; MinVersion: 0.0,6.0; Flags: nowait
Filename: "{sd}\PC_EFT\DevTools\VirtualPinpad\VirtualPinpad.exe"; WorkingDir: "{sd}\PC_EFT"; StatusMsg: "Starting Virtual PIN pad..."; Components: Development; MinVersion: 0.0,6.0; Flags: nowait
